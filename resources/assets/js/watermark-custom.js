...
/***/ function(module, exports) {
	...
	function lowerRight(alpha) {
	  return atPos(function (target, mark) {
	    return target.width - (mark.width + 0);//edit 10=>0
	  }, function (target, mark) {
	    return target.height - (mark.height + 0);//edit 10=>0
	  }, alpha);
	}
...
/***/ function(module, exports) {
	...
	function lowerRight(text, font, fillStyle, alpha, y) {
	  return atPos(function (target, metrics) {
	    return target.width - (metrics.width + 0);//edit 10=>0
	  }, function (target) {
	    return y || target.height - 0;//edit 10=>0
